...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{route('user#home')}}" class=" btn btn-primary text-decoration-none text-dark">
                    <i class="fa-solid fa-arrow-left me-1"> Back</i>
                </a>
            ...
            <div class="col-lg-7 h-auto mb-30 mt-3">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-primary px-3" id="cartBtn" type="button"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary p-3">You May Also Like</span></h2>
        <div class="row px-xl-5">
            <div class="col">
